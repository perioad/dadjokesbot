...
export const Message = {
  ...
  NewExplain: `Sorry kid, but joke explanations don't work this way anymore. Now it's way more cooler as every joke has it's own explain button! How awesome is that? 😎`,
